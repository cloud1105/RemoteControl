 ...
 */
package com.foxconn.remote.control.utils.view;
...
public class ViewUpdater {
  ...
  public TextView setRelativeTimeSpan(final View parentView,
	...
	/**
	 * Increases the hit rect of a view. This should be used when an icon is
	 * small and cannot be easily tapped on. Source:
	 ...
	 *            hit purposes.
	 * @param delegate
	 *            The view that needs to have its hit rect increased.
	 */
	 ...
	 * 
	 * @param top
	 *            The amount of dp's to be added to the top for hit purposes.
	 * @param left
	 *            The amount of dp's to be added to the left for hit purposes.
	 * @param bottom
	 *            The amount of dp's to be added to the bottom for hit purposes.
	 * @param right
	 *            The amount of dp's to be added to the right for hit purposes.
	 * @param delegate
	 *            The view that needs to have its hit rect increased.
	 */
