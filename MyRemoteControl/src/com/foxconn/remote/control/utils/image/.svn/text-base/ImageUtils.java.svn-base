 ...
 */
package com.foxconn.remote.control.utils.image;
...
public class ImageUtils {
    ...
    /**
     * 
     * get bitMap in assert file
     *
     * @param assertfileName  filePath in assert folder
     * @param context   
     * @return
     * @throws IOException
     *
     */
    public static Bitmap getBitmap(String assertfileName,Context context) throws IOException
    {
        AssetManager asset = context.getAssets();

        InputStream is = asset.open(assertfileName);
